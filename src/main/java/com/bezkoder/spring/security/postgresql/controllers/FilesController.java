...
import com.bezkoder.spring.security.postgresql.message.ResponseMessage;
...
public class FilesController {
    ...
    public ResponseEntity<List<ResponseFile>> getListFiles() {
        List<ResponseFile> files = taskService.getAllFiles().map(dbFile -> {
